...
| Approval              | app-server approval wire, core approval store and handlers                        | Cordis service                           | `planned`         | excluded from the first public commit; implementation and independent upstream conformance must close before this component is added                                                    |
...
| Apply patch           | parser, validation, mutation and result protocol                                  | tool/provider                            | `planned`         | boundary audit pending                                                                                                                                                                  |
